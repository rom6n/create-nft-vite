        ...
        <>
          ...
          >
            <div className="flex justify-between items-center">
              ...
              <button className="absolute right-[50%] translate-x-[50%] bottom-3 top-120 rounded-2xl w-[91%] h-15 border-3 border-white/50 font-semibold text-2xl bg-gradient-to-r from-sky-400/80 to-sky-700/80 cursor-pointer hover:to-sky-500/80">
                Withdraw
              </button>
            </div>
          </motion.div>
